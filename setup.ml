...
(* OASIS_START *)
(* DO NOT EDIT (digest: 11fbeaff02386b1c9ebd8e5aefb37ca1) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("ssl-doc", OCamlbuildDocPlugin.doc_build "src")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("ssl-doc", OCamlbuildDocPlugin.doc_clean "src")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "stelnet.ml"; });
               Flag
                 ({
                     cs_name = "examples";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "stalkd.ml"; });
               Doc
                 ({
                     cs_name = "ssl-doc";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for ssl";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_digest = Some "\012\186\214\227\190\195W\018\200\b0\190\173\bP\t";
     oasis_exec = None;
     oasis_setup_args = [];
     };;
